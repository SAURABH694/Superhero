// My Public API -276c6e39353bb75f934d98fb78190fbc
// MD5 Hash -   60ada66665f400b918739bca32abbaf8
...
//  If search query matches the results then it will execute next function/command.
    if(!searchQuery){
        ...
        return "https://gateway.marvel.com:443/v1/public/comics?ts=1&apikey=25025ab87d83ef6ddecee7f3041ff18b&hash=60ada66665f400b918739bca32abbaf8 "
    }else{
        return `https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=apikey=${searchQuery}&apikey=276c6e39353bb75f934d98fb78190fbc&hash=60ada66665f400b918739bca32abbaf8`
    }
}
